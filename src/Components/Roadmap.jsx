                      ...
                      <div className=' mx-0 my-12 md:!mx-12 relative after:content-[""] after:absolute after:bottom-[184px] md:after:bottom-[14%] after:left-[31px] md:after:left-[50%] after:top-[16px] after:ml-[-3px] after:w-[6px] after:bg-custom-gradient'>
                          ...
                          <div className='py-[10px] px-[40px] w-full md:w-[42%] relative left-0 font-display after:absolute md:after:right-[-69px] lg:after:right-[-22%] md:after:left-auto  after:top-[15px] after:w-[29px] after:h-[29px] after:rounded-full after:bg-no-repeat after:bg-cover after:z-[1]  after:bg-dot after:left-4 '>
                              <div className='rounded-[6px] border-[1px] ml-4  text-white py-[3px] px-[30px] relative'>
                                  <h1 className=' text-[20px] font-bold my-2'><span className='text-[#7ec273]'>Launch and Foundation</span> (2024)</h1>
                                 <p className='mb-4 text-[14px] font-medium'>Gapx Launch Event, o Partnership Announcements, Community Building, Gapxbit Exchange Launch , Educational Campaigns</p>
                              </div>
                          </div>
                          
                          <div className='py-[10px] px-[40px] w-full md:w-[42%] relative left-0 md:left-[58%] font-display after:absolute md:after:left-[-69px] lg:after:left-[-22%]  after:top-[15px] after:w-[29px] after:h-[29px] after:rounded-full after:bg-no-repeat after:bg-cover after:z-[1]  after:bg-dot after:left-4'>
                              <div className='rounded-[6px] border-[1px] ml-4  text-white py-[3px] px-[30px] relative'>
                                  <h1 className=' text-[20px] font-bold my-2'><span className='text-[#7ec273]'>Expansion and Integration</span> (2025)</h1>
                                 <p className='mb-4 text-[14px] font-medium'>Platform Integration, Marketing Initiatives, Gapx Wallet Enhancement, Strategic Partnerships</p>
                              </div>
                          </div>
                          
                          <div className='py-[10px] px-[40px] w-full md:w-[42%] relative left-0 font-display after:absolute md:after:right-[-69px] lg:after:right-[-22%] md:after:left-auto  after:left-4 after:top-[15px] after:w-[29px] after:h-[29px] after:rounded-full after:bg-no-repeat after:bg-cover after:z-[1]  after:bg-dot '>
                              <div className='rounded-[6px] border-[1px] ml-4  text-white py-[3px] px-[30px] relative'>
                                  <h1 className=' text-[20px] font-bold my-2'><span className='text-[#7ec273]'>Adoption and Global Reach</span> (2026)</h1>
                                  <p className='mb-4 text-[14px] font-medium'>Global Expansion, Enterprise Integration & User Feedback Loop</p>
                              </div>
                          </div>
                          ...
                          <div className='py-[10px] px-[40px] w-full md:w-[42%] relative left-0 font-display after:absolute md:after:right-[-69px] lg:after:right-[-22%] md:after:left-auto  after:left-4 after:top-[15px] after:w-[29px] after:h-[29px] after:rounded-full after:bg-no-repeat after:bg-cover after:z-[1]  after:bg-dot '>
                              <div className='rounded-[6px] border-[1px] ml-4  text-white py-[3px] px-[30px] relative'>
                                  <h1 className=' text-[20px] font-bold my-2'><span className='text-[#7ec273]'>Innovation and Beyond</span> (2027 AND BEYOND)</h1>
                                  <p  className='mb-4 text-[14px] font-medium'>Innovative Marketing, Thought Leadership, Sustainability Initiatives</p>
                              </div>
                          </div>
              ...
              <div className='bg-[#0d0d0d]   pb-0  lg:overflow-hidden overflow-hidden h-fit  lg:h-[80vh]'>
                  <div className='mb-12 mt-4 z-[2] relative text-white xl:max-w-[1320px] lg:max-w-[1140px] md:max-w-[960px] sm:max-w-[540px] mx-auto px-4 lg:px-8 flex flex-col  lg:flex-row  gap-0 lg:gap-[6rem]'>
                      ...
                      <div className='w-[70%] m-auto lg:m-0 md:w-1/3 py-4 lg:w-[30%] relative '>
                              ...
                              <div className='absolute h-[10vh] md:h-full lg:left-0 left-[-100px]'>
                                  
                      <div className=" absolute content-[''] w-[198.73px] h-[281.73px] rounded-[50%] md:top-[-25rem] lg:top-[-20rem] top-[-20rem] right-[0px] md:right-[0px] blur-[50px] bg-gradient-custom-glow-03"></div>
          ...
          <div className='xl:max-w-[1320px] lg:max-w-[1140px] md:max-w-[960px] sm:max-w-[540px] mx-auto relative px-4 lg:px-8 z-20 m-auto flex  '>
                  ...
                  <div className='flex lg:flex-row-reverse  flex-col gap-16'>
                      ...
                      <div className= 'w-[90%] md:w-[65%] lg:w-1/2 mt-8   text-wrap z-20'>
                          ...
                          Our audit report confirms Gap X coin's compliance with rigorous security standards, ensuring robust protection against vulnerabilities, transparency in operations, and trustworthiness in the blockchain ecosystem.</p>
